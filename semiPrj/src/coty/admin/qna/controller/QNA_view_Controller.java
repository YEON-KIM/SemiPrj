...
@WebServlet("/admin/QNA_view")
public class QNA_view_Controller extends HttpServlet {
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			req.setAttribute("QNA_Vo", vo);
			req.getRequestDispatcher("/WEB-INF/views/admin/QNA_view.jsp").forward(req, resp);
