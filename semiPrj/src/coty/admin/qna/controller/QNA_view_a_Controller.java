...
@WebServlet("/admin/QNA_view_a")
public class QNA_view_a_Controller extends HttpServlet {
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			req.getRequestDispatcher("/WEB-INF/views/admin/QNA_view_a.jsp").forward(req, resp);
