...
@WebServlet("/communication/QNA_view_c_a")
public class QNA_view_c_a_Controller extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			req.getRequestDispatcher("/WEB-INF/views/communication/QNA_view_c_a.jsp").forward(req, resp);
