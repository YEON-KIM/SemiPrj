...
<body>
   ...
   <div style="height: 600px;">
    <div class="board_wrap">
      ...
      <form action="/admin/Notice_edit" method="post" enctype="multipart/form-data">
      <div class="board_write_wrap">
          <div class="board_write">
              ...
              <div class="info">
                  <dl>
                      <dt>글쓴이</dt>
                      <dd><input type="text" name="writer" placeholder="글쓴이 입력" value="${Notice_a_Vo.writer}"></dd>
                  </dl>
              ...
              <div class="cont">
                  <textarea name="Content" placeholder="내용 입력" >${Notice_a_Vo.content}</textarea>
              </div>             
          </div>
          <div class="bt_wrap">
