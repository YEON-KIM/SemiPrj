...
<body>
	...
	<c:forEach items="${ productList10 }" var="p10">
          ...
          <td>
   		    <div class="detail" style="display: inline-block;">
           		<div >
                    ...
                    <h1 class="title">${p10.name } - ${p10.ex }</h1><br>  
                    <p class="price">${p10.price }원</p><br>
                    <div class="txtbox">
                        <p><b>${p10.ex }</b></p><p><br></p>
                      ...
                      <div class="bottombtns">
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/resources/image/product/${p10.src }/1.png" alt="">
                        </td>
                    </tr>
                    </div>
        <div class="detail_img">
            <div class="prodviewEdit"><img src="/resources/image/product/${p10.src }/2.png" alt=""></div>
            <div class="prodviewEdit"><img src="/resources/image/product/${p10.src }/3.png" alt=""></div>
        </div>
<%@include file="/WEB-INF/views/common/footer.jsp" %>
<form method="post" action="/member/cartadd" id="frm">
	<input id="pCnt" name="pCnt" type="hidden" value="">
	<input id="pNo" name="pNo" type="hidden" value="${p10.no}">
</form>
</c:forEach>
  </body>
</html>
