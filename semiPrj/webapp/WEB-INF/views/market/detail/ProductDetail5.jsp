...
<body>
	...
	<c:forEach items="${ productList5 }" var="p5">
          ...
          <td>
   		    <div class="detail" style="display: inline-block;">
           		<div >
                    ...
                    <h1 class="title">${p5.name } - ${p5.ex }</h1><br>  
                    <p class="price">${p5.price }원</p><br>
                    <div class="txtbox">
                        <p><b>${p5.ex }</b></p><p><br></p>
                      ...
                      <div class="bottombtns">
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/resources/image/product/${p5.src }/1.png" alt="">
                        </td>
                    </tr>
                    </div>
        <div class="detail_img">
            <div class="prodviewEdit"><img src="/resources/image/product/${p5.src }/2.png" alt=""></div>
            <div class="prodviewEdit"><img src="/resources/image/product/${p5.src }/3.png" alt=""></div>
        </div>
<%@include file="/WEB-INF/views/common/footer.jsp" %>
<form method="post" action="/member/cartadd" id="frm">
	<input id="pCnt" name="pCnt" type="hidden" value="">
	<input id="pNo" name="pNo" type="hidden" value="${p5.no}">
</form>
</c:forEach>
  </body>
</html>
