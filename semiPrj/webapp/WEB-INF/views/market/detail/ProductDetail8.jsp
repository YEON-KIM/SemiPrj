...
<body>
	...
	<c:forEach items="${ productList8 }" var="p8">
          ...
          <td>
   		    <div class="detail" style="display: inline-block;">
           		<div >
                    ...
                    <h1 class="title">${p8.name } - ${p8.ex }</h1><br>  
                    <p class="price">${p8.price }원</p><br>
                    <div class="txtbox">
                        <p><b>${p8.ex }</b></p><p><br></p>
                      ...
                      <div class="bottombtns">
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/resources/image/product/${p8.src }/1.png" alt="">
                        </td>
                    </tr>
                    </div>
