  ...
  <form action="" method="post">
    ...
    <table class="content" >
      ...
      <tr>
        ...
        <td ><input class="box" type="text" name="memberidnum1" placeholder="123456-000000">
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2">
          <div class="find">
            <a href="/member/login">로그인</a> | <a href="/member/missingid">아이디 찾기</a> | <a href="/member/agree">회원가입</a></td>
          </div>
      </tr>
